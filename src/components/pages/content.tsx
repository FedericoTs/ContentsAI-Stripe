    ...
    <>
      <div className="mb-6">
        ...
        <p className="text-white/70">
          Create, manage, and repurpose your content across multiple formats.
        </p>
      </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox id="punctuation" className="border-gray-700" />
                      <label htmlFor="punctuation" className="ml-2 text-sm">
                        Auto-punctuation
                      </label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="timestamps" className="border-gray-700" />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 mt-4">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="background-noise" className="ml-2 text-sm">
