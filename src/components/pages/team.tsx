          ...
          <Card className="bg-black/40 border-white/10 text-white">
            <CardHeader>
              ...
              <CardDescription className="text-white/70">
                You can invite up to {maxTeamMembers} team members with your
                current plan.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Alert className="mb-6 bg-purple-500/10 border-purple-500/20 text-purple-300">
                ...
                <AlertDescription>
                  Team management functionality will be available soon. Stay
                  tuned!
                </AlertDescription>
              </Alert>
            ...
            <CardFooter className="flex flex-col items-start gap-4 sm:flex-row sm:items-center border-t border-white/10 pt-4">
              <div className="flex-1 space-y-1">
                <div className="text-sm text-white/50">
                  ...
                  <span className="font-medium">{maxTeamMembers}</span> team
                  members used
                </div>
              </div>
